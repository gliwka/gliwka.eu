(function () {
    ...
    // Persist horizontal scroll position for the menu
    (function () {
        const menuBody = document.getElementById('menu');
        if (menuBody) {
    ...
    // Copy code button behavior (i18n resolved to English defaults)
    (function () {
        document.querySelectorAll('.cnt pre > code').forEach((codeblock) => {
